...
export function FindProgram() {
  ...
  // Generate a match score for each program (simulating ML)
  const getMatchScore = (programId: number) => {
    // Deterministic score based on program ID
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl text-gray-900">PRC Programs</h1>
              <p className="text-gray-600 mt-1">Find the right support group for your journey</p>
            </div>
            <UserProfile />
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 min-h-[600px]">
        ...
        >
              <div className="text-center mb-12">
                ...
                >
                  Need help choosing? Try the PRC Guide →
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {programs.map((program, idx) => {
                  ...
                  const matchedProgramId = localStorage.getItem("matchedProgramId");
                  const isMatchedProgram = matchedProgramId === program.id.toString();
                    ...
                    >
                      ...
                      >
                        <CardContent className="p-6 h-full flex flex-col">
                          ...
                          {/* Hover overlay with match score and intro */}
                          <AnimatePresence>
                            {isHovered && (
                              <motion.div
                                initial={{ opacity: 0 }}
